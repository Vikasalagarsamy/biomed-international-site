...
(function(){
  ...
  '<header class="nav"><div class="wrap nav-inner">'+
    ...
    '</nav>'+
    '<div class="nav-right">'+
      '<a href="/contact.html" class="btn btn-solid nav-quote">Request a quote</a>'+
  ...
  '<footer><div class="wrap"><div class="foot-grid">'+
    '<div><h5>Biomed International</h5><p class="tag">Bioceutical manufacturing since 2014 — Chondroitin Sulfate Sodium and Collagen for the pharma, nutraceutical and food industries.</p></div>'+
